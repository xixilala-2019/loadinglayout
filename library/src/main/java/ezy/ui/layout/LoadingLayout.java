...
public class LoadingLayout extends FrameLayout {
    ...
    View.OnClickListener mNetRetryClickListener = new OnClickListener() {
        @Override
        public void onClick(View v) {
            if (mNetRetryListener != null) {
                mNetRetryListener.onClick(v);
            }
        }
    };
    View.OnClickListener mRetryListener;
    View.OnClickListener mNetRetryListener;
    ...
    public LoadingLayout setNetRetryListener(OnClickListener listener) {
        mNetRetryListener = listener;
        return this;
    }
...
//    }
    ...
    private View layout(int layoutId) {
        ...
        if (layoutId == mEmptyResId) {
            ...
            ImageView netErrorImage = (ImageView) layout.findViewById(R.id.net_error_image);
            if (netErrorImage != null) {
                netErrorImage.setImageResource(mNetErrorImage);
            }
            TextView tv = (TextView) layout.findViewById(R.id.net_error_text);
            if (tv != null) {
                tv.setText(mNetErrorText);
                tv.setOnClickListener(mNetRetryClickListener);
            }
